...
import { isLlmEnabled, setLlmEnabled } from "@/services/ollama.queue.js";
...
export async function settingsRoutes(fastify: FastifyInstance) {
  ...
  fastify.get("/llm-enabled", async () => {
    return { enabled: isLlmEnabled() };
  });

  fastify.put("/llm-enabled", async (request) => {
