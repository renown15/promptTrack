            ...
            <div className="insight-detail-panel__metrics">
              {Object.entries(metricLabels).map(([name, label]) => {
                ...
                return (
                  <div
                    key={name}
                    className={`insight-detail-panel__metric ${statusClass}${override ? " insight-detail-panel__metric--has-override" : ""}`}
                  >
                    ...
                    {override && (
                      <div
                        className={`insight-detail-panel__override insight-detail-panel__override--${override.status}`}
                      >
                        <span className="insight-detail-panel__override-badge">
                          {override.source === "agent" ? "agent" : "human"}{" "}
                          override · {override.status}
                        </span>
                        <span className="insight-detail-panel__override-comment">
                          {override.comment}
                        </span>
                      </div>
                    )}
