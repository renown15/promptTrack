import type { CIStatusDTO, MetricOverrideDTO } from "@/api/endpoints/insights";
...
interface InsightDetailPanelProps {
  ...
  selectedFileOverrides: Record<string, MetricOverrideDTO>;
  detail: any;
}
    ...
    >
      {id && (
        <InsightPageModals
          ...
          selectedFileOverrides={selectedFileOverrides}
          onDetailClose={() => null}
          detail={detail}
        />
      )}
